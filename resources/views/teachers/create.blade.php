...
@section('content')
<style>
    /* Same nice CSS design used for students */
    ...
    .input-group input { width: 100%; padding: 12px; border: 1px solid #ccc; border-radius: 8px; outline: none; box-sizing: border-box; }
